        ...
        <?php
            ...
            if($vEnviado){
                if(isset($_POST['nombrePlataforma'])){
                    $vPlataformaEditada = editarPlataforma($idPlataforma,$_POST['nombrePlataforma'], $_POST['sloganPlataforma']);
                }
            }
                ...
                <div class="row justify-content-md-center">
                    <div class="col-4">
                        <input name="nombrePlataforma" id="nombrePlataforma" type="text"
                            ...
                            value="<?php if(isset($plataforma)) echo $plataforma->getNombre(); ?>">
                    </div>
                </div>
            </div>
            <div class="container">
                ...
                <div class="row justify-content-md-center">
                    <div class="col-4">
                        <input name="sloganPlataforma" id="sloganPlataforma" type="text"
                            ...
                            value="<?php if(isset($plataforma)) echo $plataforma->getSlogan(); ?>">
                    </div>
                </div>
            </div>
